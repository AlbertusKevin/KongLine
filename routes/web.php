...
Route::get('/admin/user/{id}/diikuti', [AdminController::class, 'getUserInfoDiikuti'])->middleware('admin');
Route::get('/admin/user/{id}/dibuat', [AdminController::class, 'getUserInfo'])->middleware('admin');

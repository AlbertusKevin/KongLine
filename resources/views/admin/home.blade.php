                ...
                <div class="col-sm-12">
                    ...
                    <p class="text-bold"> Service </p>
                        <div class="chat">
                            ...
                            <a href=""><i class="fa fa-chevron-right mr-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row mt-4 h-100">
        <div class="col-md-6">
            <div class="card card-admin height" id="pengajuan-donasi">
                <div class="name">
                    <p> Donasi Terbaru </p>
                    <a href="#" class="text-12">Lihat lainnya</a>
                </div>
